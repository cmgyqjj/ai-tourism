...
Page({
  data: {
    ...
    question: {
      title: '希望如何安排住宿预算?',
      options: [
        { id: 1, text: '全程平均 (每天预算均衡,不搞太大差价)', selected: false },
        { id: 2, text: '先省后花 (前面住性价比款,后面升级舒适型)', selected: false },
        { id: 3, text: '先花后省 (开头住好点,后面预算降下来)', selected: false },
        { id: 4, text: '重点住好 (核心城市/景区住高端,其他地方选经济款)', selected: false },
        { id: 5, text: '全程省着花 (优先控制成本)', selected: false },
        { id: 6, text: '我是土豪 (怎么舒服怎么来,不在意钱)', selected: false }
      ]
    },
  ...
  onLoad(options) {
    console.log('trip-questions-7页面加载，参数:', options)
  ...
  // 页面显示
  onShow() {
    console.log('trip-questions-7页面显示')
  },

  // 页面隐藏
  onHide() {
    console.log('trip-questions-7页面隐藏')
  }
}) 